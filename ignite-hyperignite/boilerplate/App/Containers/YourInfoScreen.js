...
// Styles
import styles from "./Styles/YourInfoScreenStyle";

class YourInfoScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView style={styles.container}>
          <View style={styles.section}>
            <Text style={styles.topSectionText}>Your Info</Text>
          ...
          <RoundedButton
            onPress={() => this.props.navigation.push("YourHouseInfoScreen")}
            title="Go to the app"
          >
